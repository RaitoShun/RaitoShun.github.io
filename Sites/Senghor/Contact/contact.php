...
if(isset($_POST['submit'])){
    $to = "abrahamthiao@gmail.com"; // this is your Email address
    ...
    echo 'Thanks for submitting a form!'
    }
?>
<!doctype html>
<html>
<head>
	...
	<title>Senghor-SA: Contact</title>
	<meta charset="utf-8">
...
<body>
	...
	<header class="jumbotron text-center">
		<h1><span class="rainbow outline show-up">CONTACT US</span></h1>
	</header>
	<header class="jumbotron intro text-center">
	...
	<footer class='text-center footer'>
		<ul class="icons">
			<li>
				<a rel="noopener noreferrer" target="_blank" href="https://web.facebook.com/diene.thiao">
					<span class="fa fa-facebook-f"></span>
				</a>
			</li>

			<li>
				<a rel="noopener noreferrer" target="_blank" href="https://pl.linkedin.com/in/diene-thiao-51858b2b">
					<span class="fa fa-linkedin"></span>
				</a>
			</li>
			<li>
				<a rel="noopener noreferrer" target="_blank" href="https://www.youtube.com/channel/UCP_0o0FUIDKCh3bc9IAw5lA">
